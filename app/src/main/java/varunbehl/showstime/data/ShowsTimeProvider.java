...
public class ShowsTimeProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        stayTunedDBHelper = new ShowsTimeDBHelper(getContext());
        return true;
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        queryBuilder.setTables(ShowsTimeContract.StayTunedEntry.TABLE_NAME);
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (match) {
            case EPISODE_ID:
                return ShowsTimeContract.StayTunedEntry.CONTENT_DIR_TYPE;
            default:
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        switch (uriType) {
            case EPISODE_ID: {
                long _id = db.insert(ShowsTimeContract.StayTunedEntry.TABLE_NAME, null, values);
                if (_id > 0)
                    returnUri = ShowsTimeContract.StayTunedEntry.buildTvUri();
                else
        ...
        switch (match) {
            case EPISODE_ID:
                rowsDeleted = db.delete(
                        ShowsTimeContract.StayTunedEntry.TABLE_NAME, selection, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (match) {
            case EPISODE_ID:
                rowsUpdated = db.update(ShowsTimeContract.StayTunedEntry.TABLE_NAME, values, selection,
                        selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
