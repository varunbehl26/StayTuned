package varunbehl.staytuned.widget;
...
class TvWidgetFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public void onDataSetChanged() {
        ...
        cursor = new StayTunedDBHelper(context).getReadableDatabase().rawQuery("Select * from " + StayTunedContract.StayTunedEntry.TABLE_NAME, null);
